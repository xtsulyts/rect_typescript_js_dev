...
const MainEcommerce = () => {
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      {/* Hero Banner */}
      <section className="mb-12 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 p-8 text-white">
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <button className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg bg-blue-600 py-2 text-white transition hover:bg-blue-700">
